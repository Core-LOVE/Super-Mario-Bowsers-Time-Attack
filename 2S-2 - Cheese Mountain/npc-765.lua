--Mega Spiny Strutsqueak by SpoonyBardOL

local megaspinystrutsqueak = {}

local npcManager = require("npcManager")
local squeaks = require("AI/squeaks")

local npcID = NPC_ID
local deathEffect = 765
npcManager.registerDefines(npcID, {NPC.HITTABLE})

-- settings
local megaspinystrutsqueakSettings = {
	id = npcID, 
	gfxoffsetx = 0, 
	gfxoffsety = 12, 
	width = 42, 
...
local configFile = npcManager.setNpcSettings(megaspinystrutsqueakSettings);
