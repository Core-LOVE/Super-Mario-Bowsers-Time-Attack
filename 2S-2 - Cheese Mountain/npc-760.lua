--Para-Strutsqueak by SpoonyBardOL

local parastrutsqueak = {}

local npcManager = require("npcManager")
local squeaks = require("AI/squeaks")

local npcID = NPC_ID
local deathEffect = 760
npcManager.registerDefines(npcID, {NPC.HITTABLE})

-- settings
local parastrutsqueakSettings = {
	id = npcID, 
	gfxoffsetx = 0, 
	gfxoffsety = 10, 
	width = 32, 
...
local configFile = npcManager.setNpcSettings(parastrutsqueakSettings);
