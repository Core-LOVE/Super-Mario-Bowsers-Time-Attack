--Spiny Skipsqueak by SpoonyBardOL

local spinyskipsqueak = {}

local npcManager = require("npcManager")
local squeaks = require("AI/squeaks")

local npcID = NPC_ID
local deathEffect = 753
npcManager.registerDefines(npcID, {NPC.HITTABLE})

-- settings
local spinyskipsqueakSettings = {
	id = npcID, 
	gfxoffsetx = 0, 
	gfxoffsety = 12, 
	width = 32, 
...
local configFile = npcManager.setNpcSettings(spinyskipsqueakSettings);
