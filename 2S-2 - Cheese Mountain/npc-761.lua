--Spiny Strutsqueak by SpoonyBardOL

local spinystrutsqueak = {}

local npcManager = require("npcManager")
local squeaks = require("AI/squeaks")

local npcID = NPC_ID
local deathEffect = 761
npcManager.registerDefines(npcID, {NPC.HITTABLE})

-- settings
local spinystrutsqueakSettings = {
	id = npcID, 
	gfxoffsetx = 0, 
	gfxoffsety = 12, 
	width = 32, 
...
local configFile = npcManager.setNpcSettings(spinystrutsqueakSettings);
