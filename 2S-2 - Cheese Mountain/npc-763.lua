--Mega Strutsqueak by SpoonyBardOL

local megastrutsqueak = {}

local npcManager = require("npcManager")
local squeaks = require("AI/squeaks")

local npcID = NPC_ID
local deathEffect = 763
npcManager.registerDefines(npcID, {NPC.HITTABLE})

-- settings
local megastrutsqueakSettings = {
	id = npcID, 
	gfxoffsetx = 0, 
	gfxoffsety = 8, 
	width = 42, 
...
local configFile = npcManager.setNpcSettings(megastrutsqueakSettings);
